...
const Signin = () => {
  ...
  const formValidation = () => {
    ...
    if (!passwordRegex.test(password)) {
      setError(
        "Password must be at least 6 characters with a capital letter and a number"
      );
      return false;
    }
  ...
  return (
    <section className="min-h-screen flex items-stretch text-white font-poppins font-normal">
      ...
      <div
        className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-[#6b7280] dark:bg-black"
      >
        <div className="absolute z-[1] w-[45%] h-[45%] rounded-full bottom-40 blue__gradient dark:white__gradient" />
        <div
          className="absolute lg:hidden overflow-hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center"
          style={{ backgroundImage: `url(${robot})` }}
        >
          <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
        </div>
        <div className="w-full py-0 z-20">
          <h1 className="w-auto h-7 ss:h-8 inline-flex">
            <img src={logo} alt="hoobank" className="w-[248px] h-[72px]" />
          </h1>
          <p className={`${styles.heading3} text-gray-100`}>Get quickly started with </p>
          ...
          <p className="text-gray-100">or use your email address</p>
          <form
          ...
          >
            ...
            <div className="w-full rounded-full bg-blue-gradient">
              <button
                type="submit"
